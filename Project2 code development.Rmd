...
#  }
  ...
  agency_options <- c("Department of Defense", "Department of Agriculture", "General Services Administration", "Department of Housing and Urban Development", "Department of Veterans Affairs", "Social Security Administration", "Department of Health and Human Services", "Federal Communications Commission", "Small Business Administration", "Railroad Retirement Board")
  
  agency_codes <- c("097", "012", "047", "086", "036", "028", "075", "027", "073", "060")
  
  
  
  ifelse(
    agency_name %in% agency_key$agency_name, 
    print(agency_key$agency_code), 
...
#    } 
  ...
  report_options <- c("Budgetary Resources", "Federal Account", "Obligation Type", "Award Obligations", "Program Activity")
  
  endpoint_options <- c("budgetary_resources", "federal_account", "object_class", "obligations_by_award_category", "program_activity")
  
  ifelse(report %in% report_options, #c("Budgetary Resources", "Federal Account", "Obligation Type", "Award Obligations", "Program Activity"),
          print(endpoint_options), 
          print("Error: Incorrect Report Type")
